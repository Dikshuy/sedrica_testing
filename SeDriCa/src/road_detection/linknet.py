...
def pre_encoder(inputs):
	...
	pre_enc_2=slim.conv2d(pre_enc_1,encoder_dict["1"]["m"], kernel_size=3, stride=2, rate=1,padding='SAME')
	return pre_enc_2
def post_decoder(inputs,classes):
	...
	post_decoder_3=slim.conv2d_transpose(post_decoder_2,post_decoder_dict["c"]["n"],kernel_size=3,stride=2,padding='SAME')
